...
data_train = np.load(PATH + 'TEST2_som_data_train_CAT3norm.npy')
time_values = np.load(PATH +'TEST2_som_time_data_CAT3norm.npy')
z_raw = xr.open_dataset(PATH + 'VER2_SOM_Z_raw_CAT3norm.nc')
...
norm_factor = [0.10014513220331027, 0.10251989701956438, 0.1285688367470829] # Z500 
norm_factor = norm_factor[2] # you need to change this
...
som_names = "SOM_CAT3_" + str(today) + "_" + str(som_col) + "by" + str(som_row) + "_LR" + str(learning_rate) + "_sig" + str(sigma) + "_n_"
print(som_names)
